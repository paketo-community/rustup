...
func NewRustup(dependency libpak.BuildpackDependency, cache libpak.DependencyCache) (Rustup, libcnb.BOMEntry) {
	contributor, entry := libpak.NewDependencyLayer(dependency, cache, libcnb.LayerTypes{
		Build: true,
		Cache: true,
	})
	return Rustup{LayerContributor: contributor}, entry
}
